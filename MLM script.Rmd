...
dhps_sub <- subset(mipfull2, mipfull2$POS ==549685 | mipfull2$POS == 550117 | mipfull2$POS == 549993)
...
adult_ind<- dhs_sub[c(1,7:11,13)]

## hv270 is the wealth variable 
kids_ind<- dhps_snps[c("Barcode", "A437G", "K540E", "A581G", "mixed", "hv001", "hv270")]
...
mut_tab <- table(ind_full$dhps_mut)
mut_tab

mut_year <- table(ind_full$dhps_mut, ind_full$year)
mut_year
