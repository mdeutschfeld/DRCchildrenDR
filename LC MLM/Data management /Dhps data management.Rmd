...
dhs_sub$mv024[is.na(dhs_sub$mv024)] <- 0 # making these zero so we can add the two columns together
...
adult_ind<- dhs_sub[c("barcode", "wealthindex", "cluster", "province", "A437G", "K540E", "A581G", "mixed", "samp_weight")]

## hv270 is the wealth variable 
kids_ind<- dhps_snps[c("Barcode", "A437G", "K540E", "A581G", "mixed", "hv001", "hv270", "hv024", "hv005")]
